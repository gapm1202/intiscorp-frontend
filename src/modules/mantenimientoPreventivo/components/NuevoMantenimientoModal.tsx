...
export default function NuevoMantenimientoModal({ onClose }: NuevoMantenimientoModalProps) {
        ...
        <form className="flex-1 overflow-y-auto" onSubmit={(e) => e.preventDefault()}>
          <div className="px-7 py-6 space-y-7">
            ...
            <div>
              ...
              <input type="date" className={inputCls + ' max-w-xs'} />
            </div>
          ...
          <div className="sticky bottom-0 bg-white border-t border-slate-100 px-7 py-4 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              className="flex items-center gap-2 px-6 py-2.5 bg-blue-700 hover:bg-blue-800 text-white text-sm font-bold rounded-lg transition shadow-md shadow-blue-200"
            >
